                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-p35b">
                                              ...
                                              <p>
                                                6th Floor, Awfis, Suncity Success Tower, Sector - 65, Chair, Gurugram, Haryana, India, 122018
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td align="left" class="esd-block-text es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l">
                                              <p>
                                                Hi, ${name}! We have received a request for appointment.&nbsp;
                                              </p>
                                              <p>
                                                ​
                                              </p>
                                              <p>
                                                Date of appointment: ${appointmentDate}<br>Phone Number: ${phoneNumber}<br>Service: ${service}
                                              </p>
                                              <p>
                                                ​
                                              </p>
